...
import fr.mqrtin.utility.module.impl.property.properties.TextProperty;
...
public class TextComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString(this.property.getName().replace("-", " ") + ": " + this.property.getValue(), (float) ((this.module.category.getX() + 4) * 2), (float) ((this.module.category.getY() + this.offsetY + 5) * 2), -1, false);
        GL11.glPopMatrix();
    }
    ...
    public void mouseDown(int x, int y, int button) {
        if (this.isHovered(x, y) && button == 0 && this.module.panelExpand) {
            // TODO: Implémenter dialog de texte
        }
    }
