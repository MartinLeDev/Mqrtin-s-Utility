...
public class ModeComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString("§9" + mode.substring(0, 1).toUpperCase() + mode.substring(1).toLowerCase(), (float) ((this.parentModule.category.getX() + 4 + bruhWidth) * 2), (float) ((this.parentModule.category.getY() + this.offsetY + 4) * 2), -1, true);
        GL11.glPopMatrix();
    }
