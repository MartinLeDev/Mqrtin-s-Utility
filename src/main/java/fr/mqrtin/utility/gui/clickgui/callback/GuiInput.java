...
public class GuiInput extends GuiScreen {
    ...
    private final Runnable onCallbackComplete;
    ...
    public GuiInput(String title, String defaultValue, Consumer<String> callback, GuiScreen caller) {
        ...
        this.caller = caller;
        this.onCallbackComplete = null;
    }

    public GuiInput(String title, String defaultValue, Consumer<String> callback, GuiScreen caller, Runnable onCallbackComplete) {
        this.title = title;
        this.defaultValue = defaultValue;
        this.callback = callback;
        this.caller = caller;
    ...
    public static void prompt(String title, String defaultValue, Consumer<String> callback, GuiScreen caller, Runnable onCallbackComplete) {
        Minecraft.getMinecraft().displayGuiScreen(new GuiInput(title,defaultValue, callback, caller, onCallbackComplete));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        if (button == buttonOk) {
            ...
            if (onCallbackComplete != null) onCallbackComplete.run();
        }
