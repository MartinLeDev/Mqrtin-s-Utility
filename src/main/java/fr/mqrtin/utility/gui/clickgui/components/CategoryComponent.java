...
public class CategoryComponent {
    ...
    public ArrayList<Module> modulesInCategory = new ArrayList<>();
    public ArrayList<Component> modulesShowed = new ArrayList<>();
    ...
    public CategoryComponent(String category, List<Module> modules, ModuleCategory moduleCategory) {
        ...
        this.marginX = 80;
        this.marginY = 4.5;
        this.modulesInCategory = new ArrayList<Module>(modules);
        this.category = moduleCategory;
        updateModules();
    }

    public void updateModules(){
        this.modulesShowed.clear();
        int tY = this.bh + 3;

        for (Module mod : modulesInCategory) {
            ModuleComponent b = new ModuleComponent(mod, this, tY);
            this.modulesShowed.add(b);
        }
    }

    public ArrayList<Component> getModules() {
        return this.modulesShowed;
    }
    ...
    public void render(FontRenderer renderer) {
        ...
        update();
        height = 0;
        for (Component moduleRenderManager : this.modulesShowed) {
        ...
        if (this.categoryOpened && !this.modulesInCategory.isEmpty()) {
            ...
            for (Component c2 : this.modulesShowed) {
    ...
    public void update() {
        ...
        for (Component component : this.modulesShowed) {
